...
def test_default_argument_values_not_correct_when_missing_paragraphs(not_verifiable_gg_args_missing_paragraphs):
    """The default command-line arguments are not correct"""
    gg_arguments = gatorgrader.parse_gatorgrader_arguments(not_verifiable_gg_args_missing_paragraphs)
    gatorgrader_args_verified = gatorgrader.verify_gatorgrader_arguments(
        gg_arguments)
    assert gatorgrader_args_verified == NOT_VERIFIED
