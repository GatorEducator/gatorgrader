"""Check that a file in a directory contains a specified number of paragraphs."""
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="CountFileParagraphs",
        description="Check Provided by GatorGrader: CountFileParagraphs",
...
def act(main_parsed_arguments, check_remaining_arguments):
    ...
    # This means that the use of check_CountFileParagraphs would have already failed by this
