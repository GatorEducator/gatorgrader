"""Check that a file in a directory contains a specified number of multiple-line comments."""
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="CountMultipleLineComments",
        description="Check Provided by GatorGrader: CountMultipleLineComments",
...
def act(main_parsed_arguments, check_remaining_arguments):
    ...
    # This means that the use of check_CountMultipleLineComments would have already failed by this
