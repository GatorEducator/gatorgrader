"""Check that a file exists in a directory."""
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="FindFile",
        description="Check Provided by GatorGrader: FindFile",
...
def act(main_parsed_arguments, check_remaining_arguments):
    ...
    # This means that the use of check_FindFile would have already failed by this
