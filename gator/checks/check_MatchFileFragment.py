"""Check that a file's contents match a specified fragment."""
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="MatchFileFragment",
        description="Check Provided by GatorGrader: MatchFileFragment",
    ...
    # REQUIRED? Yes
    required_group.add_argument(
        "--count", type=int, help="how many of a fragment should exist", required=True
    )
